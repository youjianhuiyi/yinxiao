...
class Production extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('production',['primary key'=>'id','auto_increment'=>true,'engine'=>'innodb','comment'=>'产品文案库'])->addIndex('id');
        $table
            ->addColumn('name','string',['limit'=>30,'null'=>false,'default'=>'','comment'=>'产品名称'])
            ...
            ->addColumn('qr_image','string',['limit'=>255,'null'=>false,'default'=>'','comment'=>'微信客服二维码'])
            ->addColumn('modulefile','string',['limit'=>255,'null'=>false,'default'=>'','comment'=>'文案模板'])
            ...
            ->addColumn('status','integer',['limit'=>\Phinx\Db\Adapter\MysqlAdapter::INT_TINY,'default'=>0,'comment'=>'是否上架，0=上架，1=下架'])
