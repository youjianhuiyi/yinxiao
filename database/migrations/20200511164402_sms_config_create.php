...
class SmsConfigCreate extends Migrator
{
    ...
    public function change()
    {
        ...
        $table
            ...
            ->addColumn('template_1','text',['null'=>false,'default'=>'','comment'=>'短信模板1'])
            ->addColumn('template_2','text',['null'=>false,'default'=>'','comment'=>'短信模板2'])
            ->addColumn('template_3','text',['null'=>false,'default'=>'','comment'=>'短信模板3'])
            ->addColumn('template_4','text',['null'=>false,'default'=>'','comment'=>'短信模板4'])
            ->addColumn('template_5','text',['null'=>false,'default'=>'','comment'=>'短信模板5'])
