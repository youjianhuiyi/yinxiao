define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'data/visit/index' + location.search,
                    add_url: 'data/visit/add',
                    edit_url: 'data/visit/edit',
                    del_url: 'data/visit/del',
                    multi_url: 'data/visit/multi',
                    table: 'visit_ip',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'data/visit/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
